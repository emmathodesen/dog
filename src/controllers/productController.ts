...
/**
 * Retrives all products from the data sources 
 * @param req
 * @param res
 */
export async function getAllProducts(req: Request, res: Response)  {
    ...
    try {
        ...
        res.status(500).send("Error retriving products. Error: " +err);
    }
    finally {
        await disconnect();
    }
...
export async function getProductById(req: Request, res: Response)  {
    ...
    try {
        ...
        res.status(500).send("Error retriving product by id . Error: " +err);
    }
    finally {
        await disconnect();
    }
